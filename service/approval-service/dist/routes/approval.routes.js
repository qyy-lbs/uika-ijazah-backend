...
router.get("/batches/pending", verifyToken, verifyApprovalRole, getPendingBatches);
router.get("/batches/:batchCode", verifyToken, verifyApprovalRole, getBatchDetail);
router.post("/batches/:batchCode/approve", verifyToken, verifyApprovalRole, approveBatch);
router.post("/batches/:batchCode/reject", verifyToken, verifyApprovalRole, rejectBatch);
router.post("/mahasiswa/:mahasiswaCode/revoke", verifyToken, verifyApprovalRole, revokeMahasiswa);
router.get("/laporan", verifyToken, verifyReportAccess, getLaporanApproval);
