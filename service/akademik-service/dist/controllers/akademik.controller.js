...
const getMahasiswaIdFromUuid = async (mahasiswaCode) => {
    if (!mahasiswaCode) {
...
export async function getTranskrip(req, res) {
    try {
        const mahasiswaId = await getMahasiswaIdFromUuid(req.params.mahasiswaCode);
...
export async function getValidasiAkademik(req, res) {
    try {
        const mahasiswaId = await getMahasiswaIdFromUuid(req.params.mahasiswaCode);
