...
export async function getTranskripByMahasiswaId(mahasiswaId) {
    ...
    const ipkHitung = totalSks > 0 ? Number((totalBobot / totalSks).toFixed(2)) : 0;
...
//# sourceMappingURL=transkrip.service.js.map