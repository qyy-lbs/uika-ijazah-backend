import { getLatestValidationRepository, } from "../repositories/dashboard.repository.js";
import { mapDashboardStatus, } from "../helpers/dashboard.helper.js";
export const getLatestValidationService = async (page, limit, search) => {
    const result = await getLatestValidationRepository(page, limit, search);
...
export const getDashboardSummaryService = async () => {
    const result = await getLatestValidationRepository(1, 100000, "");
    const rows = result.data;
    const summary = {
        totalIjazahTerbit: 0,
