...
export const getDetailBatchRepository = async (id_batch_upload) => {
    return await prisma.$queryRawUnsafe(`
    WITH latest_validasi AS (
      SELECT DISTINCT ON (id_mahasiswa)
        id_mahasiswa,
...
export const getBatchRepository = async (page, limit, tahun_lulus, periode, search, status) => {
