...
import { createUser, getAllUsers, deleteUser, editUser ,changePassword, restoreUser} from '../controllers/userController.js';
...
router.patch("/restoreUser/:id", authorizeRoles("admin"), restoreUser);
