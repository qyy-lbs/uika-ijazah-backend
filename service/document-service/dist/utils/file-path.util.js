...
export function getDocumentOutputPath(params) {
    ...
    const absoluteDir = path.join(process.cwd(), "uploads", "documents", params.jenis);
...
//# sourceMappingURL=file-path.util.js.map